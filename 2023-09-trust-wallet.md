...
TrustWallet: missing proper access control in the SmartVault contract about the output token amount.
...
Assuming Alice is going to exchange ETH for DONUT, using TrustWallet mobile app. Here's how Bob attacks:
